...
public class PingMonitor {
    ...
    private static volatile String DEFAULT_PING_ADDRESS = CloudCityParamsRepository.getInstance().getServerUrl();//"8.8.8.8";   //TODO fix me properly with new environments
